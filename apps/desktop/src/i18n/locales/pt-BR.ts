...
export default withEnglishFallback({
  ...
  settings: {
    ...
    remoteApiTitle: "Remote DBX API",
    remoteApiDescription: "Point this local UI at a remote dbx-web API (server stores connections and runs queries). Same idea as CLI/MCP DBX_WEB_URL.",
    remoteApiUrl: "API Base URL",
    remoteApiUrlPlaceholder: "https://dbx.example.com",
    remoteApiPassword: "Web Login Password",
    remoteApiPasswordHint: "Same password as the remote Web login / DBX_WEB_PASSWORD.",
    remoteApiEnvOverride: "Env override active (VITE_DBX_WEB_URL). Clear env to use settings below.",
    remoteApiSave: "Save & Reload",
    remoteApiClear: "Use Local Backend",
    remoteApiSaved: "Remote API saved. Reloading…",
    remoteApiCleared: "Switched back to local backend. Reloading…",
    remoteApiUrlInvalid: "Enter a valid http(s) URL, or leave empty for local backend.",
